        ...
        g = (function () {
          ...
          return (
            ...
            (t.prototype._writeImpl = function (t) {
              ...
              for (
                var e = void 0, r = void 0, n = void 0, o = [];
          ...
          function (t, e, r) {
              ...
              d = (function () {
                ...
                return (
                  ...
                  (t.prototype._readTokenImpl = function () {
                    ...
                    if (t)
                      return (this.stream = this.stream.slice(t.length)), t;
                  }),
            ...
            (e["default"] = d),
              ...
              (d.escapeAttributes = function (t) {
                ...
                for (var r in t)
                  t.hasOwnProperty(r) &&
                    (e[r] = (0, f.escapeQuotes)(t[r], null));
                return e;
              }),
              (d.supports = s);
            for (var y in s)
              s.hasOwnProperty(y) &&
                (d.browserHasFlaw = d.browserHasFlaw || (!s[y] && y));
          },
          function (t, e) {
            "use strict";
            e.__esModule = !0;
            ...
            function i(t) {
              ...
              if (e !== -1) {
                ...
                if (r) {
                  ...
                  if (
                    "object" === ("undefined" == typeof n ? "undefined" : u(n))
                  )
                    return n.v;
                }
              }
                    ...
                    (t.formatTag = function (t) {
                      ...
                      for (var n in t.attrs)
                        if (t.attrs.hasOwnProperty(n)) {
                          r += " " + n;
                          var i = t.attrs[n];
                          ("undefined" != typeof t.booleanAttrs &&
                            "undefined" != typeof t.booleanAttrs[n]) ||
                            (r += '="' + (0, o.escapeQuotes)(i) + '"');
                        }
                      return (
                        t.rest && (r += " " + t.rest),
          ...
          function (t, e) {
            ...
            function r(t) {
              return (
                t &&
                  "startTag" === t.type &&
                  ((t.unary = s.test(t.tagName) || t.unary),
              ...
              var c = i(),
                l = {
                  ...
                  endTag: function (r) {
                    var n = c.last();
                    n
                      ? e.tagSoupFix && !c.lastTagNameEq(r.tagName)
                        ? o(t, c)
                        : c.pop()
                      : e.tagSoupFix && (a(), s());
                  },
